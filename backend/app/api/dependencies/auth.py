...
from app.models.smart_user import UserInDB
from app.api.dependencies.database import get_repository
from app.db.repositories.smart_users import UsersRepository
from app.services import auth_service

oauth2_scheme = OAuth2PasswordBearer(tokenUrl=f"{API_PREFIX}/smart_users/login/token/") # This class simply informs FastAPI that the URL provided is the one used to get a token
